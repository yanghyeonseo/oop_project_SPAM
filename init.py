...
try:
    ...
    ninja_sheild_img = pygame.image.load('./img/ninjasheet_aura.png')
    skeleton_img = pygame.image.load('./img/skeletonsheet.png')
    skeleton_sheild_img = pygame.image.load('./img/skeletonsheet_aura.png')
...
player_dict = {1: [prince_img, prince_shield_img], 2: [princess_img, princess_shield_img],
               3: [pinky_img, pinky_shield_img], 4: [ninja_img, ninja_sheild_img],
               5: [skeleton_img, skeleton_sheild_img]}
